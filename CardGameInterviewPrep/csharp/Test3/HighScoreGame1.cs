...
namespace Test3
{
    internal class HighScoreGame1
    {
        public List<Player> Players = new List<Player>();
        public Deck Deck = new Deck();
        public HighScoreGame1(string[] names, bool includeJokers = false, int? seed = null)
        {
        ...
        public int PointOf(Card card) => card.Strength + 1;

        public int ScoreHand(Player player) => player.Hand.Sum(PointOf);
